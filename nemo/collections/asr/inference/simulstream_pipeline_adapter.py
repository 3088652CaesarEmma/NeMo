...
class NeMoStreamingPipelineAdapter(SpeechProcessor):
    ...
    wav_names: list[str] = []
    reference_manifest_by_audio: dict[str, dict] = {}
    reference_manifest_by_basename: dict[str, dict] = {}
    reference_manifest_items_ordered: list[dict] = []
    cfg = None
    _wer_calculated: bool = False
